...
namespace WebMVCAppWithStoredProcedureNView.Models
{
        ...
        public class StudentDBHandle
        {
            ...
            // ********** VIEW STUDENT DETAILS With Stored procedure ********************
        ...
        // ********** VIEW STUDENT DETAILS With Stored procedure ********************
        public List<StudentModel> View_GetStudent()
        {
            connection();
            List<StudentModel> studentlist = new List<StudentModel>();

            SqlCommand cmd = new SqlCommand("allStudentList", con);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter sd = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
